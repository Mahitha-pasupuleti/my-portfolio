...
const skillsData = [
  ...
  },
  {
    ...
    skills: ["Object Oriented Design", "SOLID Principles", "ACID Principles", "Design Patterns", "Unit Testing"]
  },
  {
  ...
  },
  {
    ...
    skills: ["Spring Framework", "SpringBoot", "Spring Security", "GraphQL", 
      "Hibernate", "Spring Data JPA", "WebSockets", "Node.js", "Express.js", "Flask"]
  },
  {
  ...
  },
  {
    ...
    skills: ["AWS", "EC2", "S3", "IAM", "Elasticsearch", "Kafka", "RabbitMQ", "PySpark", 
      "Databricks", "Terraform", "Hadoop", "CloudFront"]
  },
  {
    category: "DevOps & Tools",
    iconClass: "fas fa-tools",
    skills: ["GitHub Copilot", "Claude Code", "Docker", "Kubernetes", "Helm", "Git", "GitLab", "Ansible", "Maven", "Gradle", 
      "Jira", "Postman", "Mulesoft", "Splunk"]
  }
];
